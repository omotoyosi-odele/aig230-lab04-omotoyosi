...
I did a comparison of Word2Vec and FastText using the target word "space" to determine the differences between the top 10 neighbors and their prediction scores given windos of 2 and 10.
